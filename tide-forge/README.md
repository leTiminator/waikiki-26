...
- **Status:** **M1** — the core (palette, pixel-matrix, depth-grade, corruption) plus four live
  modules: **Creatures**, **Flora**, **Tiles** (47-tile blob autotiling) and **VFX**, with
  procedural animation clips, an asset library, a palette editor, and spritesheet / tilesheet /
  JSON export.
...
## Use it
1. Pick a **module** — Creatures, Flora, Tiles, VFX (Props and Characters land in M2).
